    ...
    private static final class LoanProductMapper implements RowMapper<LoanProductData> {
        ...
        public String loanProductSchema() {
            return "lp.id as id, lp.fund_id as fundId, f.name as fundName,lp.product_type_id productTypeId, lp.product_category_id productCategoryId, lp.loan_transaction_strategy_id as transactionStrategyId, ltps.name as transactionStrategyName, "
                    ...
                    + " lp.is_islamic as isIslamic, lp.financing_partner_code as financingPartnerCode, lp.allowable_dscr as allowableDSCR "
        ...
        public LoanProductData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final String financingPartnerCode = rs.getString("financingPartnerCode");
            ...
            loanProductData.setFinancingPartnerCode(financingPartnerCode);
