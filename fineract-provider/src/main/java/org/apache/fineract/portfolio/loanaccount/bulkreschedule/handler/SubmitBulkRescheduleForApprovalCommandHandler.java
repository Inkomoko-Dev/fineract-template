...
import org.apache.fineract.portfolio.loanaccount.bulkreschedule.service.BulkRescheduleAlertService;
...
public class SubmitBulkRescheduleForApprovalCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        alertService.notifySubmittedForApproval(execution, user, approver, submissionNote.trim());
