...
public class LoanProductsApiResource {
    ...
    private final Set<String> loanProductDataParameters = new HashSet<>(Arrays.asList("id", "name", "shortName", "description", "fundId",
            ...
            LoanProductConstants.FINANCING_PARTNER_CODE));
    ...
    private LoanProductData handleTemplate(final LoanProductData productData) {
        ...
        loanProductDataResponse.setFinancingPartnerCode(productData.getFinancingPartnerCode());
        loanProductDataResponse.setFinancingPartnerCodeOptions(Arrays.asList(FinancingPartnerCode.KIFIYA));
