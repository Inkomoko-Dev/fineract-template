...
public interface ProvisionBatchJournalRepository extends JpaRepository<ProvisionBatchJournal, Long> {

    List<ProvisionBatchJournal> findByBatchId(Long batchId);
