...
@Entity
@Table(name = "voice_ivr_session")
@Getter
@Setter
@NoArgsConstructor
public class VoiceIvrSession extends AbstractPersistableCustom {
    ...
    private VoiceIvrSessionStatus sessionStatus;
    ...
    public static VoiceIvrSession startNew(final String externalSessionId, final String callerNumber, final Client client,
            final Staff staff, final String languageMenuKey, final LocalDateTime expiresAt) {
        ...
        session.sessionStatus = VoiceIvrSessionStatus.LANGUAGE_SELECTION;
        session.currentMenuKey = languageMenuKey;
