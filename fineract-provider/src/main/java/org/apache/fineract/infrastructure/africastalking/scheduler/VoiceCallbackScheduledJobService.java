...
public class VoiceCallbackScheduledJobService {

    private final VoiceCallbackDispatchService callbackDispatchService;

    @CronTarget(jobName = JobName.DISPATCH_SCHEDULED_VOICE_CALLBACKS)
    public void dispatchScheduledVoiceCallbacks() {
        callbackDispatchService.dispatchDueCallbacks();
    }
}
