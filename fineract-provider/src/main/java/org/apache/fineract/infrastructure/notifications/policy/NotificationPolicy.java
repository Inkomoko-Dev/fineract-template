...
public interface NotificationPolicy {
    ...
    boolean isAllowed(NotificationCommand command);

    default boolean isAllowed(final NotificationChannel channel, final String phoneNumber, final NotificationPurpose purpose) {
        return true;
    }
}
