...
public interface VoiceCallQueueEntryRepository extends JpaRepository<VoiceCallQueueEntry, Long> {

    List<VoiceCallQueueEntry> findByDepartmentCodeAndStatusOrderByCreatedDateAsc(String departmentCode, VoiceCallQueueStatus status);
