...
public class WhatsAppSlaMonitorScheduledJobService {
    ...
    public void monitorSlaBreaches() {
        ...
        final List<WhatsAppSupportTicket> breachedTickets = ticketRepository.findSlaBreachedTickets(now,
                List.of(WhatsAppTicketStatus.RESOLVED, WhatsAppTicketStatus.CLOSED));
        for (final WhatsAppSupportTicket ticket : breachedTickets) {
            operationalNotificationService.notifySlaBreach(ticket);
        }
    }
}
