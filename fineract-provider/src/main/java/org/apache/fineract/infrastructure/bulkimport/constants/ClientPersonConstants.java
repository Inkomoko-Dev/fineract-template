...
public final class ClientPersonConstants {
    ...
    public static final int MIGRATED_COL = 15;// P
    public static final int MIGRATED_ON_DATE_COL = 16;// Q
    public static final int MIGRATED_FROM_OFFICE_COL = 17;// R
    public static final int ADDRESS_ENABLED_COL = 18;// S
    public static final int ADDRESS_TYPE_COL = 19;// T
    public static final int STREET_COL = 20;// U
    public static final int ADDRESS_LINE_1_COL = 21;// V
    public static final int ADDRESS_LINE_2_COL = 22;// W
    public static final int ADDRESS_LINE_3_COL = 23;// X
    public static final int CITY_COL = 24;// Y
    public static final int STATE_PROVINCE_COL = 25;// Z
    public static final int COUNTRY_COL = 26;// AA
